...
final class DMTextView: UIView, Validatable {
    ...
    override var intrinsicContentSize: CGSize {
        let height = Margins.large + Sizes.big + Margins.xSmall + errorMessageLabel.intrinsicContentSize.height
...
private extension DMTextView {
    ...
    func setupLayout() {
        ...
        contentView.add(views: [textView, placeholderLabel, errorMessageLabel], constraints: [
            ...
            textView.heightAnchor.constraint(equalToConstant: Sizes.big),
